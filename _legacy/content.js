/**
 * CHCS website — all wording lives HERE.
 *
 * To update the site: edit this file only (or ask your tech person to paste your changes).
 * After saving, refresh the page in the browser.
 *
 * When you deploy for real, set previewBanner to null to hide the preview strip.
 */
window.CHCS_CONTENT = {
  previewBanner:
    "Preview for the committee — same information as chcstemple.org, new design. Not live yet.",
  ...
  events: {
    ...
    intro:
      "All are welcome at CHCS, 16 Ostade Road, London SW2. These dates match what we publish on chcstemple.org today. When this site goes live, the committee can refresh this list in one place—no need to learn the old website builder.",
    items: [
      {
        dateLabel: "Date and time is TBD",
        title: "Vasant Panchami and Saraswati Mata Puja",
        meta: "CHCS",
        href: "https://www.chcstemple.org/event-info/vasant-panchami-and-saraswati-mata-puja",
        cta: "More info",
      },
      {
        dateLabel: "Sat 15 Mar",
        title: "Holi Celebration (Phagwa)",
        meta: "CHCS",
        href: "https://www.chcstemple.org/event-info/holi-celebration-phagwa",
        cta: "More info",
      },
      {
        dateLabel: "Thu 13 Mar",
        title: "Holika Dahan (Burning of Holi)",
        meta: "CHCS",
        href: "https://www.chcstemple.org/event-info/holika-dahan-burning-of-holi",
        cta: "More info",
      },
      {
        dateLabel: "Wed 26 Feb",
        title: "Maha Shiva Ratri",
        meta: "CHCS",
        href: "https://www.chcstemple.org/event-info/maha-shiva-ratri",
        cta: "More info",
      },
      {
        dateLabel: "Tue 14 Jan",
        title: "Makar Sankranti",
        meta: "CHCS",
        href: "https://www.chcstemple.org/event-info/makar-sankranti",
        cta: "More info",
      },
      {
        dateLabel: "Sat 2 Nov",
        title: "Diwali Puja and Celebration",
        meta: "CHCS",
        href: "https://www.chcstemple.org/event-info/diwali-puja-and-celebration-2",
        cta: "More info",
      },
      {
        dateLabel: "Multiple dates (from Sun 13 Oct)",
        title: "Navaratri & Devi Bhagwattam Yajna",
        meta: "CHCS",
        href: "https://www.chcstemple.org/event-info/navaratri-devi-bhagwattam-yajna-2024-10-13-09-00",
        cta: "More info",
      },
    ],
  },
  ...
  leadership: {
    sectionTitle: "Executive Committee & priests",
  ...
  visit: {
    ...
    membershipParagraphs: [
      "Join us in supporting the temple with a yearly membership of just £15. Your contribution will help us maintain our community and continue our important. Together, we can make a difference ensure the temple remains a welcoming space for all.",
      "Please email om@chcstemple.org for more information on how to join or use the form below. Thank you for your support!",
    ],
  ...
  footer: {
    line: "© 2024 Caribbean Hindu Cultural Society · 16 Ostade Road, London SW2 2BB",
